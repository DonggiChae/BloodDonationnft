...
export default function RequestDonationUpdateForm(props) {
  const {
    id,
    requestDonation,
    onSuccess,
  ...
  const [requestDonationRecord, setRequestDonationRecord] =
    React.useState(requestDonation);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id
        ? await DataStore.query(RequestDonation, id)
        : requestDonation;
      setRequestDonationRecord(record);
    };
    queryData();
  }, [id, requestDonation]);
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(
            RequestDonation.copyOf(requestDonationRecord, (updated) => {
